...
! calculate pressure by fluctuation of energy during a trial move (without calculating virial)
! This should be uncommented when use "Pressure1" instead of "Pressure" in the .inp file for pressure output
! For details (how to convert the output energy fluctuation to system pressure), see J. Chem. Phys. 105, 8469, 1996
! The size of trial volume change used here is 25.0 Angstrom^3
