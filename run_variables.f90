...
! Atom placement variables
 ...
 !***************************************************************
  ...
  INTEGER, DIMENSION(:), ALLOCATABLE :: nbonds, nangles, nhybonds
  ...
  TYPE(HY_Bond_Class), DIMENSION(:,:), ALLOCATABLE, TARGET :: hy_bond_list
...
! multiparticle move 
  ...
  LOGICAL :: three_body, HB_term

  REAL(DP) :: binary_kij_1, binary_kij_2, binary_kij_3, binary_kij_4, binary_kij_5, binary_kij_6
 ! pressure calculation using trial volume change in GEMC-NVT simulation

  REAL(DP) :: HB_scale_1, HB_scale_2 ! to scale the HB interaction between CO2 and H2O
