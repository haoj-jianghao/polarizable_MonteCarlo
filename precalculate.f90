...
!LOGICAL, INTENT(OUT), optional :: mpm_logical
 ...
 shell_mpm = .FALSE.
  ...
  ALLOCATE( Mxx(MAXVAL(nmolecules),nspecies), stat = AllocateStatus)
  ALLOCATE( Myy(MAXVAL(nmolecules),nspecies), stat = AllocateStatus)
  ALLOCATE( Mzz(MAXVAL(nmolecules),nspecies), stat = AllocateStatus)

  ALLOCATE( Fxx(MAXVAL(natoms), MAXVAL(nmolecules),nspecies) , stat = AllocateStatus)
  ALLOCATE( Fyy(MAXVAL(natoms), MAXVAL(nmolecules),nspecies) , stat = AllocateStatus)
  ALLOCATE( Fzz(MAXVAL(natoms), MAXVAL(nmolecules),nspecies) , stat = AllocateStatus)

  ALLOCATE(drudeFx(maxval(nmolecules),maxval(natoms),nspecies))
  ALLOCATE(drudeFy(maxval(nmolecules),maxval(natoms),nspecies))
  ALLOCATE(drudeFz(maxval(nmolecules),maxval(natoms),nspecies))
  ALLOCATE(dmpmx(sum(nmolecules), nspecies), dmpmy(sum(nmolecules), nspecies), dmpmz(sum(nmolecules), nspecies))
  ALLOCATE(thetax(sum(nmolecules), nspecies), thetay(sum(nmolecules), nspecies), thetaz(sum(nmolecules), nspecies))
